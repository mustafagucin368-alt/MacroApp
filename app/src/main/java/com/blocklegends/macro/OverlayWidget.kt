...
class OverlayWidget(private val context: Context) {
    ...
    private fun dismissPickOverlay() {
        pickOverlayView?.let { try { windowManager.removeView(it) } catch (e: Exception) {} }
        pickOverlayView = null; isPicking = false
    }
}
